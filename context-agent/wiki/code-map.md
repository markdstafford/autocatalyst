...
Last updated: 2026-06-08 (orchestrator service ingress: orchestrator + control-plane-service + run events + bounded dispatch + conversation ingress routes/SDK; end-to-end proven)
