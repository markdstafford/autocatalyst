...
Last updated: 2026-06-09 (runner boundary, execution context, and stub runner: runner event vocabulary + declarative ExecutionContext schemas in api-contract; execution-context-resolver, runner-event-stream, execution-run-unit-of-work adapters in core; Runner interface, MaterializedExecutionEnvironment, ExecutionSecretResolver, execution-entry-point, StubRunner, execution-materializer, workspace-root-guard in execution; SqliteSecretStore now implements SecretResolver; full dispatch boundary proven by integration tests. Out of scope: runner event persistence/SSE replay, provider adapters/model routing, hardened shell/LSP backends, result-tolerance correction, remote git/branch/PR workflows, UI.)
